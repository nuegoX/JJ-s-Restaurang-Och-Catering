...
const Hitta = () => {
    ...
    return (
       ...
       <div className={`mt-[70px] md:mt-0 p-3 text-center border-t border-orange-300 flex flex-col w-full ${!onmobile ? 'max-w-5xl mr-4 ml-4 mt-0' : ''} h-fit justify-center md:justify-between items-center pb-40 md:pb-0 bg-black ${onmobile && "bg-[url('http://jjrestaurang.se/ImageSlider/1568/201311041383570893HrxLiVKW.jpg')] h-[90vh] object-cover bg-cover"}`}>
          <h1 className='text-white text-3xl sm:text-4xl mt-10'>HITTA TILL OSS!</h1>
          <p className='text-white sm:text-xl md:text-base'>J&J Restaurang & Catering finns sedan 2006 i Länsstyrelsen hus. Nischen för JJ restaurang är att erbjuda en bred meny. Här kan dem flesta hittar något som faller i smaken. Internationell vällagad mat med inspiration från Sydamerika, Asien och framförallt alltid vällagad Svensk husmanskost. </p>
